		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Teste",
									"targetURL": "#projetoteste-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projetoteste-display": {
								"semanticObject": "projetoteste",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projetoteste",
									"url": sap.ui.require.toUrl("projetoteste")
								}
							}
						}
					}
